...
//! - `luna`: `luna-send-pub` calls over an open connection, one-shot and
//!   subscribed.
//! - `apps`: list, install and remove homebrew apps and IPKs.
//! - `devmode`: device info and the Developer Mode session's remaining time.
//!
