...
void main() {
  test('parses a catalog entry matching the live apps.json shape', () {
    final CatalogPackage package = CatalogPackage.fromJson({
      ...
      'iconUri':
          'https://repo.webosbrew.org/apps/icons/org.webosbrew.hbchannel.png',
      'manifestUrl':
      ...
      'featured': true,
      'fullDescriptionUrl':
          'apps/org.webosbrew.hbchannel/full_description.html',
    });
    ...
    expect(
      package.manifest.ipkUrl,
      'https://repo.webosbrew.org/apps/example.ipk',
    );
  ...
  test('parses a manifest with no ipkHash instead of throwing '
  ...
  test(
    'parses detailIconUri, requirements, rootRequired and installedSize',
    () {
      final CatalogPackage package = CatalogPackage.fromJson({
  ...
  test(
    'defaults rootRequired to false and installedSize/detailIconUri to null',
    () {
      final CatalogPackage package = CatalogPackage.fromJson({
